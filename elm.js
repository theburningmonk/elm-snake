...
var _user$project$Main$Snake = F2(
	function (a, b) {
		return {segments: a, direction: b};
	});
var _user$project$Main$Right = {ctor: 'Right'};
var _user$project$Main$initSnake = {
	segments: _elm_lang$core$List$reverse(
		A2(
			_elm_lang$core$List$map,
			function (n) {
				return {ctor: '_Tuple2', _0: n * _user$project$Main$segmentDim, _1: 0};
			},
			_elm_lang$core$Native_List.range(0.0, 8.0))),
...
var _user$project$Main$Started = F2(
	function (a, b) {
