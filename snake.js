...
var _user$project$Main$randPos = A2(
	...
	A2(_elm_lang$core$Random$float, 0, 1));
var _user$project$Main$randGen = A2(
	_elm_lang$core$Random$pair,
	A2(_elm_lang$core$Random$float, 0, 1),
	_user$project$Main$randPos);
var _user$project$Main$pos = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Main$_p0 = {ctor: '_Tuple2', _0: 500, _1: 500};
...
var _user$project$Main$isGameOver = F2(
	function (newHead, newTail) {
		return A2(
			...
			_user$project$Main$width / 2) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(newHead),
			_user$project$Main$height / 2) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$fst(newHead),
			(0 - _user$project$Main$width) / 2) < 0) || (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(newHead),
			(0 - _user$project$Main$height) / 2) < 0))));
	});
var _user$project$Main$spawnCherry = F2(
	function (randW, randH) {
		var y = (randH * _user$project$Main$height) - (_user$project$Main$height / 2);
		var x = (randW * _user$project$Main$width) - (_user$project$Main$width / 2);
		return _elm_lang$core$Maybe$Just(
			A2(_user$project$Main$pos, x, y));
	});
...
var _user$project$Main$segmentDim = 15;
var _user$project$Main$view = function (model) {
				...
				return A2(
					...
					A2(
						...
						A2(
							_evancz$elm_graphics$Collage$filled,
							_elm_lang$core$Color$white,
							_evancz$elm_graphics$Collage$circle(_user$project$Main$cherryRadius))),
					A2(
						_elm_lang$core$List_ops['::'],
						scoreLbl,
						A2(_elm_lang$core$List_ops['::'], head, tail)));
	...
	var bg = A2(
		...
		A2(
			...
			_elm_lang$core$Basics$toFloat(_user$project$Main$width),
			_elm_lang$core$Basics$toFloat(_user$project$Main$height)));
...
var _user$project$Main$getNewSegment = F2(
	function (_p9, direction) {
		...
		switch (_p11.ctor) {
			case 'Up':
				return A2(_user$project$Main$pos, _p12, _p13 + _user$project$Main$segmentDim);
			case 'Down':
				return A2(_user$project$Main$pos, _p12, _p13 - _user$project$Main$segmentDim);
			case 'Left':
				return A2(_user$project$Main$pos, _p12 - _user$project$Main$segmentDim, _p13);
			default:
				return A2(_user$project$Main$pos, _p12 + _user$project$Main$segmentDim, _p13);
		}
	});
...
var _user$project$Main$Snake = F3(
	function (a, b, c) {
		return {head: a, tail: b, direction: c};
	});
var _user$project$Main$Right = {ctor: 'Right'};
var _user$project$Main$initSnake = {
	head: {ctor: '_Tuple2', _0: 0, _1: 0},
	tail: A2(
		_elm_lang$core$List$map,
		function (n) {
			return {ctor: '_Tuple2', _0: (0 - n) * _user$project$Main$segmentDim, _1: 0};
		},
			...
			switch (_p15.valueOf()) {
				case 'a':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_List.fromArray(
							[_user$project$Main$Up, _user$project$Main$Down]),
						_1: _user$project$Main$Left
					};
				case 'w':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_List.fromArray(
							[_user$project$Main$Left, _user$project$Main$Right]),
						_1: _user$project$Main$Up
					};
				case 'd':
					return {
						ctor: '_Tuple2',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p16.ctor === 'NotStarted') {
			...
			switch (_p18.ctor) {
				case 'KeyPress':
					var newDir = A2(_user$project$Main$getNewDirection, _p18._0, _p22.direction);
					var newSnake = _elm_lang$core$Native_Utils.update(
						_p22,
						{direction: newDir});
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$Started, newSnake, _p20, _p21),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Spawn':
					if (_elm_lang$core$Native_Utils.cmp(_p18._0._0, 0.1) < 1) {
						...
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Main$Started, _p22, newCherry, _p21),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				default:
					var oldBody = A2(_elm_lang$core$List_ops['::'], _p22.head, _p22.tail);
					var newHead = A2(_user$project$Main$getNewSegment, _p22.head, _p22.direction);
					...
					var newCherry = ateCherry ? _elm_lang$core$Maybe$Nothing : _p20;
					var newScore = ateCherry ? (_p21 + 1) : _p21;
					var newTail = ateCherry ? oldBody : A2(
						_elm_lang$core$List$take,
						_elm_lang$core$List$length(oldBody) - 1,
						oldBody);
					var newSnake = _elm_lang$core$Native_Utils.update(
						_p22,
					...
					return gameOver ? {ctor: '_Tuple2', _0: _user$project$Main$NotStarted, _1: _elm_lang$core$Platform_Cmd$none} : (_elm_lang$core$Native_Utils.eq(newCherry, _elm_lang$core$Maybe$Nothing) ? {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_elm_lang$core$Random$generate, _user$project$Main$Spawn, _user$project$Main$randGen),
