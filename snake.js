...
var _user$project$Main$initSnake = function () {
	var tail = A2(
		_elm_lang$core$List$map,
		function (n) {
			return A2(_user$project$Main$pos, (0 - n) * _user$project$Main$segmentDim, 0);
		},
		_elm_lang$core$Native_List.range(1, 8));
	var head = {ctor: '_Tuple2', _0: 0, _1: 0};
	return {head: head, tail: tail, direction: _user$project$Main$Right};
}();
